...
*   **过期策略 (TTL)**: 设置为 `86400` 秒 (24小时)。因为日线数据每天收盘才更新一次，无需永久存储。
...
*   **Value 内容示例 (JSON)**:
    ```json
    {
      ...
      "data": [
        { "d": "2020-01-01", "o": 213.5, "h": 214.0, "l": 212.0, "c": 213.8, "v": 3000000 },
        { "d": "2020-01-02", "o": 214.0, "h": 215.5, "l": 213.5, "c": 215.2, "v": 3200000 }
        // ... 更多历史数据
      ]
    }
    ```
    *注：为了减少 KV 存储体积，键名使用了缩写 (d=date, o=open, c=close 等)。*
