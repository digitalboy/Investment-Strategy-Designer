...
<template>
    <Card
        class="border-slate-200/50 shadow-xl shadow-slate-200/50 bg-linear-to-br from-white via-lime-50/55 to-emerald-100/45 backdrop-blur-sm">
        ...
        <CardContent class="flex flex-col gap-4 text-sm text-slate-600">
            <div class="rounded-2xl border border-emerald-100 bg-linear-to-br from-emerald-50/50 to-lime-50/30 p-4">
