            ...
            <Dialog :open="showCommentsDialog" @update:open="showCommentsDialog = $event">
                <DialogContent
                    ...
                    <div
                        ...
                        <div v-if="currentStrategyComments.length === 0" class="text-center text-slate-400 py-12">
                            <div class="flex flex-col items-center gap-3">
                                <div
                        ...
                        <div v-for="comment in currentStrategyComments" :key="comment.id" class="flex gap-3">
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center mb-1.5">
                                    <span class="text-xs font-semibold text-slate-700">{{ comment.user_email || '匿名用户'
                                        }}</span>
